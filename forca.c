...
int main ()
{
 ...
 do{
  system("cls");
  puts("___________   \n|         |   \n|        _|_\n|         O   Jogo da Forca \n|        /|\\  \n|        / \\ \n| \n| \n| \n");
  puts("Instrucoes: Para ser jogado por duas pessoas: a primeira pessoa digita uma palavra e a segunda tenta advinhar o que foi digitado.\n");
  confirmar = 'n';
  while(confirmar != 'S')
    {
      certo = 0;
